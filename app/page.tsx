  ...
  return (
    <main dir="rtl" className="min-h-screen flex flex-col items-center px-4 py-16 relative overflow-hidden"
      ...
      <div className="text-center mb-10 relative z-10">
        {/* Outlined hollow title like yuvalswissa.com */}
        <h1
          className="tracking-widest leading-none mb-1 select-none"
          style={{
            fontFamily: "var(--font-karantina), sans-serif",
            fontSize: "clamp(3.5rem, 12vw, 6rem)",
            fontWeight: 700,
            WebkitTextStroke: "2px #4a9ebe",
            color: "transparent",
        ...
        {/* Colored filled word */}
        <h1
          className="tracking-widest leading-none mb-4"
          style={{
            fontFamily: "var(--font-karantina), sans-serif",
            fontSize: "clamp(3.5rem, 12vw, 6rem)",
            fontWeight: 700,
      ...
      <div className="w-full max-w-xl relative z-10">
        {!preview ? (
          ...
          <div className="space-y-4">
            {/* Preview */}
            <div className="relative rounded-2xl overflow-hidden" style={{ border: "1px solid #ffffff15" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={preview} alt="תמונה שהועלתה" className="w-full object-cover max-h-72" />
              <button onClick={reset} className="absolute top-3 left-3 rounded-full p-1.5 transition" style={{ background: "rgba(0,0,0,0.7)", border: "1px solid #ffffff20" }}>
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {!result && (
              ...
              >
                <div
                  ...
                  style={{
                    background: loading ? "linear-gradient(135deg, #7C3AED33, #EC489933)" : "linear-gradient(135deg, #7C3AED, #EC4899)",
                      ...
                      {result.actors_recognized && result.actors_recognized.length > 0 && (
                        <div className="flex flex-wrap gap-2">
                          {result.actors_recognized.map(actor => (
                            <span key={actor} className="px-2.5 py-1 rounded-full text-xs" style={{ background: "#7C3AED22", border: "1px solid #7C3AED55", color: "#C4B5FD" }}>
                              {actor}
                            </span>
                          ))}
                        </div>
